...
class PredictionRequest(BaseModel):
    ...
    daytime_evening_attendance: int = Field(
        ..., ge=0, le=1, description="1=Daytime, 0=Evening"
    )
    ...
    educational_special_needs: int = Field(
        ..., ge=0, le=1, description="Educational special needs"
    )
    debtor: int = Field(..., ge=0, le=1, description="Is debtor")
    tuition_fees_up_to_date: int = Field(
        ..., ge=0, le=1, description="Tuition fees up to date"
    )
    gender: int = Field(..., ge=0, le=1, description="0=Female, 1=Male")
    scholarship_holder: int = Field(
        ..., ge=0, le=1, description="Is scholarship holder"
    )
    ...
    curricular_units_1st_sem_credited: int = Field(
        ..., ge=0, description="1st sem credited units"
    )
    curricular_units_1st_sem_enrolled: int = Field(
        ..., ge=0, description="1st sem enrolled units"
    )
    curricular_units_1st_sem_evaluations: int = Field(
        ..., ge=0, description="1st sem evaluations"
    )
    curricular_units_1st_sem_approved: int = Field(
        ..., ge=0, description="1st sem approved units"
    )
    curricular_units_1st_sem_grade: float = Field(
        ..., ge=0, le=20, description="1st sem grade"
    )
    ...
    curricular_units_2nd_sem_credited: int = Field(
        ..., ge=0, description="2nd sem credited units"
    )
    curricular_units_2nd_sem_enrolled: int = Field(
        ..., ge=0, description="2nd sem enrolled units"
    )
    curricular_units_2nd_sem_evaluations: int = Field(
        ..., ge=0, description="2nd sem evaluations"
    )
    curricular_units_2nd_sem_approved: int = Field(
        ..., ge=0, description="2nd sem approved units"
    )
    curricular_units_2nd_sem_grade: float = Field(
        ..., ge=0, le=20, description="2nd sem grade"
    )
...
class PredictionResponse(BaseModel):
    ...
    prediction: str = Field(
        ..., description="Predicted outcome: Dropout, Enrolled, or Graduate"
    )
